...
# ckpts_path="\
# ensemble_checkpoints/checkpoint_${checkpoint}_3.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_7.pt\
# "

# ckpts_path="\
# ensemble_checkpoints/checkpoint_${checkpoint}_4.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_11.pt\
# "

# ckpts_path="\
# ensemble_checkpoints/checkpoint_${checkpoint}_8.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_13.pt\
# "

# ckpts_path="\
# ensemble_checkpoints/checkpoint_${checkpoint}_7.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_2.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_3.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_6.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_13.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_9.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_10.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_11.pt\
# "
...
ensemble_checkpoints/checkpoint_${checkpoint}_3.pt:\
ensemble_checkpoints/checkpoint_${checkpoint}_9.pt:\
ensemble_checkpoints/checkpoint_${checkpoint}_5.pt:\
ensemble_checkpoints/checkpoint_${checkpoint}_7.pt:\
ensemble_checkpoints/checkpoint_${checkpoint}_4.pt\
"
...
# ensemble_checkpoints/checkpoint_${checkpoint}_10.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_11.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_12.pt\
# echo $ckpts_path
# exit
# ensemble_checkpoints/checkpoint_${checkpoint}_1.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_2.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_3.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_4.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_5.pt:\
...
# ensemble_checkpoints/checkpoint_${checkpoint}_12.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_13.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_14.pt:\
# ensemble_checkpoints/checkpoint_${checkpoint}_15.pt:\
...
for element in "${l_pairs[@]}"
    do
        ...
        gen_file="results_ensemble/${model}/${gen_subset}/${l_pair[0]}-${l_pair[1]}/${checkpoint}.gen"
        ref_file="results_ensemble/${model}/${gen_subset}/${l_pair[0]}-${l_pair[1]}/${checkpoint}.ref"
        hyp_file="results_ensemble/${model}/${gen_subset}/${l_pair[0]}-${l_pair[1]}/${checkpoint}.hyp"
        detok_hyp_file="results_ensemble/${model}/${gen_subset}/${l_pair[0]}-${l_pair[1]}/${checkpoint}.detok_hyp"
        ...
        mkdir -p results_ensemble/${model}/${gen_subset}/${l_pair[0]}-${l_pair[1]}
